...
Testing the sphix-gallery contruction of example pages and downloadable .py and .ipynb files

This file contains a misc set of random code and text snippets to test functionality. 
